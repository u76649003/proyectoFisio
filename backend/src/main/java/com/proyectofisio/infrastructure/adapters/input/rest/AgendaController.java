...
public class AgendaController implements AgendaControllerDocs {
    ...
    @Override
    @PostMapping
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('FISIOTERAPEUTA') or hasAuthority('RECEPCIONISTA') or hasAuthority('DUENO')")
    ...
    @Override
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('DUENO') or hasAuthority('FISIOTERAPEUTA') or hasAuthority('RECEPCIONISTA') or hasAuthority('PACIENTE')")
    ...
    @Override
    @GetMapping
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('DUENO') or hasAuthority('FISIOTERAPEUTA') or hasAuthority('RECEPCIONISTA')")
    ...
    @PreAuthorize("hasAuthority('ADMIN') or hasAuthority('DUENO') or hasAuthority('FISIOTERAPEUTA')")
